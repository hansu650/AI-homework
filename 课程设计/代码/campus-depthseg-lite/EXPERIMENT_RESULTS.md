...
Direct RGB-D concatenation is the strongest variant in this run. It improves over
RGB-only on mIoU, pixel accuracy, mean accuracy, and every per-class IoU. The
